...
import comp559.a2Achievements.Achievements;
...
public class A2App implements SceneGraphNode, Interactor {
    ...
    public A2App() {
        ...
        loadSystem("data2/lcp.png"); // good default scene
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        windowWidth = drawable.getWidth();
        windowHeight = drawable.getHeight();
        if ( run.getValue() ) {
        ...
        int ID = 260353748;
        Achievements.check( drawable, ID, system );
    ...
    public JPanel getControls() {
        ...
        load.addActionListener( new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                File f = FileSelect.select("png", "image", "load", "data2/", true );
                if ( f != null ) {
        ...
        component.addKeyListener( new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if ( e.getKeyCode() == KeyEvent.VK_SPACE ) {
                    ...
                    File f = FileSelect.select("png", "image for factory", "load", "data2/", true );
                    if ( f != null ) {
                        loadFactorySystem( f.getPath() );
                    }   
                } else if ( e.getKeyCode() == KeyEvent.VK_F ) {                                       
                    loadFactorySystem( "data2/tetrisTube.png" );
